  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white rounded-xl shadow-xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">{t("cancel.description")}</p>
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <ul className="list-disc pl-5 space-y-1">
                  <li>{t("cancel.reason1")}</li>
                  <li>{t("cancel.reason2")}</li>
                  <li>{t("cancel.reason3")}</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <h3 className="font-semibold text-blue-800 mb-2">
              {t("cancel.orderDetails")}
            </h3>
            <div className="text-sm text-blue-700 space-y-1">
              <p>
                {t("cancel.orderNumber")}:{" "}
        ...
        <div className="mb-8">
          <h3 className="text-sm font-medium text-gray-700 mb-3">
            {t("cancel.commonReasons")}:
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
            <div className="bg-gray-50 p-3 rounded">
              <span className="text-gray-500">💳</span>
              <p className="text-gray-600">{t("cancel.reasonCard")}</p>
            </div>
            <div className="bg-gray-50 p-3 rounded">
              <span className="text-gray-500">⏰</span>
              <p className="text-gray-600">{t("cancel.reasonTime")}</p>
            </div>
            <div className="bg-gray-50 p-3 rounded">
              <span className="text-gray-500">🤔</span>
              <p className="text-gray-600">{t("cancel.reasonChange")}</p>
            </div>
            <div className="bg-gray-50 p-3 rounded">
              <span className="text-gray-500">📱</span>
              <p className="text-gray-600">{t("cancel.reasonTechnical")}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-sm text-gray-500 mb-3">{t("cancel.needHelp")}</p>
