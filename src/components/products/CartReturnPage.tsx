...
//       try {
//         // 🔹 Sprawdzenie płatności w Stripe
//         const statusRes = await fetch(
//           `http://localhost:3000/cart-session-status?session_id=${sessionId}`,
//           {
//             headers: {
...
//         if (statusData.status === "complete" && user && token) {
//           // 🔹 Zapis zamówienia do bazy danych
//           const orderRes = await fetch("http://localhost:3000/cart-purchase", {
//             method: "POST",
//             headers: {
...
//             setPurchases(
//               orderData.order.products.map((p: any) => ({
...
//             dispatch(clearCart());
//           } else {
//             setMessage("❌ Błąd podczas zapisu zamówienia.");
//           }
//         } else {
//           setMessage("⚙️ Płatność w trakcie przetwarzania...");
//         }
//       } catch (err) {
//         console.error(err);
//         setMessage("❌ Wystąpił błąd podczas sprawdzania płatności.");
